package com.mimosa.firedance.configuration;

import com.mimosa.firedance.service.DancingUserDetailService;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    @Autowired
    private BCryptPasswordEncoder pBCryptPasswordEncoder;
    @Autowired
    private DancingUserDetailService pDancingUserDetailService;

    @Override
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        auth.userDetailsService(pDancingUserDetailService).passwordEncoder(pBCryptPasswordEncoder);
    }
